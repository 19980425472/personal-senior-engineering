...
export default {
    ...
    prompt: {
        ...
        scopes: config.scopes.map((scope) => scope.name),
        allowCustomScopes: config.features.allowCustomScopes,
        allowBreakingChanges: config.features.allowBreakingChanges,
        skipQuestions: config.features.skipQuestions,
